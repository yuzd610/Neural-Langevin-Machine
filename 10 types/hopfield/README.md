...
- digit_step_*.pdf : Snapshots of the noisy image recovering step-by-step.
- energy_descent_main.pdf : Plot showing the continuous decrease in kinetic energy.
- original_digit_6.pdf : Ground truth clean baseline image.

Configuration
Key parameters used in the scripts:
- N: 784 (Dimensionality of original images, 28x28 flattened MNIST)
